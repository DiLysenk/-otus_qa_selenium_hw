...
class AdminPage(BasePage):
    ...
    def add_product(self, model):
        ...
        self.sending_keys(self.element(self.PRODUCT_NAME), model)
        self.sending_keys(self.element(self.META_TAG_TITLE), model)
        self.simple_click_element(self.element_text('Data'))
        self.sending_keys(self.element(self.MODEL), model)
